...
if (streetTouring.reachedExactListings / streetTouring.exactListings < 0.87) {
  throw new Error("Exact official Street Touring selector reachability fell below 87%");
}
